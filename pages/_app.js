...
export default function App({ Component, pageProps }) {
	...
	const title = "Portfolio | Noman Shakir";
	const description =
		"Hello! Noman Shakir (CodeWithZavi), a passionate web developer and problem solver. Welcome to my portfolio";
	const avatar =
	...
	const url = "https://codewithzaviportfolio.vercel.app/";
	...
	return (
		<>
			<Head>
				...
				<meta name="twitter:creator" content="@CodeWithZavi" />
